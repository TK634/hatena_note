...
export const GENRES: Genre[] = [
...

  {
    ...
    name: "美容・コスメ",
    topics: [
      "プチプラコスメで垢抜ける！2024年最新おすすめファンデーション10選",
    ...
    affiliateLinks: {
      ...
      美容本: {
        美肌の教科書: "https://www.amazon.co.jp/dp/4065222060/?tag=REPLACE-22",
      },
    },
    blog: {
      type: "hatena",
      hatenaEmail: process.env.HATENA_EMAIL_BEAUTY ?? "",
      hatenaUrl: process.env.BLOG_URL_BEAUTY ?? "https://takataka634-beauty.hatenablog.com/",
    },
...

  {
    ...
    name: "不動産・住宅ローン",
    topics: [
      "住宅ローン金利比較2024【固定vs変動どちらが得か徹底解説】",
    ...
    affiliateLinks: {
      ...
      不動産本: {
        お金の大学: "https://www.amazon.co.jp/dp/4023319074/?tag=REPLACE-22",
        不動産投資の学校: "https://www.amazon.co.jp/dp/4534059124/?tag=REPLACE-22",
      },
    },
    blog: {
      type: "hatena",
      hatenaEmail: process.env.HATENA_EMAIL_REALESTATE ?? "",
      hatenaUrl: process.env.BLOG_URL_REALESTATE ?? "https://takataka634-realestate.hatenablog.com/",
    },
...

  {
    ...
    blog: {
      type: "hatena",
      hatenaEmail: process.env.HATENA_EMAIL_FXCREDIT ?? "",
      hatenaUrl: process.env.BLOG_URL_FXCREDIT ?? "https://takataka634-fxcredit.hatenablog.com/",
    },
